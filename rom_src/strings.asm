...
str_FF_port:           DEFSTR "Port #FF"
str_FF_port_timex:     DEFSTR "    Timex"
str_FF_port_zx:        DEFSTR " Spectrum"
str_SD_memory:         DEFSTR "Mem. with SD"
str_SD_memory_256:     DEFSTR " 256kB"
str_SD_memory_384:     DEFSTR " 384kB"
